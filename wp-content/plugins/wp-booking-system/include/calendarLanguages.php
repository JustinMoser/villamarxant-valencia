...
function wpbsDoW($language){
    $translatedMonths = array(
        ...
        'bg' => array('H','п','в','с','ч','п','с','н','п','в','с','ч','п'), /*Bulgarian*/
        'cn' => array('日','一','二','三','四','五','六','日','一','二','三','四','五'), /*Chinese*/
        'zh' => array('日','一','二','三','四','五','六','日','一','二','三','四','五'), /*Chinese*/		
        'ca' => array('D','D','D','D','D','D','D','D','D','D','D','D','D'), /*Catalan*/
        'hr' => array('N','P','U','S','Č','P','S','N','P','U','S','Č','P'), /*Croatian*/
        'cs' => array('N','P','Ú','S','Č','P','S','N','P','Ú','S','Č','P'), /*Czech*/
        ...
        'sr' => array('Н','П','У','С','Ч','П','С','Н','П','У','С','Ч','П'), /*Serbian*/
        'sl' => array('N','P','T','S','Č','P','S','N','P','T','S','Č','P'), /*Slovenian*/
