...
//-----------------------------------------------------
    $themo_blog_category_meta_box = array(
        ...
        'title' => __('Category Filter', 'bellevue'),
        'pages' => array('page'),
        'context' => 'normal',
        'priority' => 'default',
        'fields' => array(
...
//-----------------------------------------------------
    $themo_page_layout_meta_box = array(
        ...
        'title' => __('Page Layout', 'bellevue'),
        'pages' => array('page','themo_room'),
        'context' => 'side',
        'priority' => 'default',
        'fields' => array(
            // START PAGE LAYOUT META BOX
            ...
            array(
                ...
                'choices' => array(
                    array(
                        'value' => 'left',
                        'label' => __('Left Sidebar', 'bellevue'),

                    ),
                    array(
                        'value' => 'right',
                        'label' => __('Right Sidebar', 'bellevue'),

                    ),
                    array(
                        'value' => 'full',
                        'label' => __('No Sidebar', 'bellevue'),
    ...
    $themo_holes_meta_box = array(
        ...
        'title' => __('Hole Page Options', 'bellevue'),
        ...
        'fields' => array(
            ...
            array(
                'id'          => "_holes_image",
                'label'       => __( 'Thumbnail Image', 'bellevue'),
                'type'        => 'upload',
