...
if(!empty($_POST['export_style'])) {
    ...
    set_theme_mod( 'dtbwp_site_style', esc_attr( !empty($_POST['export_style']) ? $_POST['export_style'] : basename(get_theme_mod('dtbwp_site_style',$this->get_default_theme_style()))) );

	$export_dir = get_home_path() . 'wp-content/themes/bellevue/plugins/envato_setup/content/';
	...
	$post_types      = array( 'attachment', 'themo_room', 'post', 'page' );
