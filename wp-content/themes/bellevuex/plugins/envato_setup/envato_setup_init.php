            ...
            class dtbwp_Envato_Theme_Setup_Wizard extends Envato_Theme_Setup_Wizard {
                ...
                public function init_globals() {
                    ...
                    $this->site_styles = array(
                        'style1' => 'Rustic - Chalet',
                        'style2' => 'Lakeshore - Cabin',
                        'style3' => 'Long Beach - Beach House',
                        'style4' => 'Parksville - Countryside',
                        'style5' => 'Yaletown - Urban Guest House',
                        'style6' => 'Bellevue - Hotel',
                        'style7' => 'Yaletown - One Pager',
                    );
                ...
                public function theme_setup_wizard_content($content){
                    if($this->is_possible_upgrade()){
                        array_unshift_assoc($content,'upgrade',array(
                            'title' => __( 'Upgrade', 'bellevue' ),
                            'description' => __( 'Upgrade Content and Settings.', 'bellevue' ),
                            'pending' => __( 'Pending.', 'bellevue' ),
                            'installing' => __( 'Installing Updates.', 'bellevue' ),
                            'success' => __( 'Success.', 'bellevue' ),
                ...
                public function envato_setup_readyX() {
                    ...
                    <div class="envato-setup-next-steps">
                        ...
                        <div class="envato-setup-next-steps-last">
                            <h2><?php esc_html_e( 'More Resources', 'bellevue' ); ?></h2>
                            <ul>
                                ...
                                <li class="howto"><a href="https://wordpress.org/support/"
                                                     target="_blank"><?php esc_html_e( 'Learn how to use WordPress', 'bellevue' ); ?></a>
                                </li>
                                <li class="rating"><a href="http://themeforest.net/downloads"
                                                      target="_blank"><?php esc_html_e( 'Leave an Item Rating', 'bellevue' ); ?></a></li>
